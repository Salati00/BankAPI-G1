...
public class User   {
   ...
   * @return username
   **/
  @Schema(example = "JohnDoe123", required = true, description = "")
      @NotNull
   ...
   * @return email
   **/
  @Schema(example = "JohnDoe123@hotmail.com", description = "")
   ...
   * @return phone
   **/
  @Schema(example = "0612345678", description = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, username, firstName, lastName, email, phone, transactionlimit, role);
  }
